...
use App\Services\PaymentService\UpaymentsService;
...
class UpaymentsController extends PaymentBaseController
{
    use OnResponse, ApiResponse;

    public function __construct(private UpaymentsService $service)
    {
