...
use App\Models\Page;
use App\Services\PaymentService\NoonService;
...
use App\Http\Controllers\API\v1\Dashboard\Admin\UltraMsgController;
...
Route::group(['prefix' => 'v1', 'middleware' => ['block.ip']], function () {
    ...
    Route::group(['prefix' => 'rest'], function () {
        ...
        Route::get('coupon-details/{id}',                       [Rest\CouponController::class, 'show']);
        Route::get('coupons/payment',               [Rest\CouponController::class, 'couponPayments']);
        ...
        /*Shiiping Company*/
        Route::get('shipping-companies',                     [Rest\ShippingCompanyController::class, 'index']);
    ...
    Route::group(['prefix' => 'dashboard', 'middleware' => ['sanctum.check']], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            Route::post('upayments-process',     [Payment\UpaymentsController::class,       'processTransaction']);
            Route::post('noon-process',          [Payment\NoonController::class,       'processTransaction']);
            Route::post('tap-process',           [Payment\TapController::class,       'processTransaction']);

            //Routes for payments callbacks
            Route::get('upayments-callback',     [Payment\UpaymentsController::class,       'callback']);
            Route::get('noon-callback',          [Payment\NoonController::class,       'callback']);
            Route::get('tap-callback',           [Payment\TapController::class,       'callback']);


            // Route::post('bank-transfer-process-process',        [Payment\IyzicoController::class,       'processTransaction']);
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:seller|manager'], 'as' => 'admin.'], function () {
            ...
            Route::get('order/printAwb',                   [Admin\OrderController::class, 'printAwb']);
            ...
            Route::post('orders/update/status',                 [Admin\OrderController::class, 'UpdateOrderStatus']);
            ...
            /* Report Carts */
            Route::get('cart/report/paginate',    [Admin\CartReportController::class, 'index']);
            ...
            /*Shipping Order*/
            Route::apiResource('shipping-order',          Admin\ShippingOrderController::class);
            Route::delete('shipping-order/delete',        [Admin\ShippingOrderController::class, 'destroy']);
            Route::get('shipping-order/drop/all',         [Admin\ShippingOrderController::class, 'dropAll']);

            /*Shipping Company*/
            Route::apiResource('shipping-companies',          Admin\ShippingCompanyController::class);
            Route::delete('shipping-companies/delete',        [Admin\ShippingCompanyController::class, 'destroy']);
            Route::get('shipping-companies/drop/all',         [Admin\ShippingCompanyController::class, 'dropAll']);
            /* Ads Package */
    ...
    Route::group(['prefix' => 'webhook'], function () {
        ...
        Route::any('iyzico/payment',       [Payment\IyzicoController::class,      'paymentWebHook']);
        ...
        Route::get('/payment/success', [NoonService::class, 'handleReturnUrl']);

    });
});

// ultra message
Route::post('/ultraMessage', [UltraMsgController::class, 'sendSMS'])->name('ultra-message');
